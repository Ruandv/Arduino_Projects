...
{       
  print_to_serial("Trying to sms - Chcking bod and picture");
        ...
        print_to_serial("Trying to sms - setting jsonObject");
         print_to_serial(topic);
         print_to_serial(to_number);
         print_to_serial(from_number); 
         print_to_serial(message_body);
         print_to_serial(picture_url);
